...
public class JsxEngine {
    ...
    public JsxEngine() {
        ...
        try {
            ...
            sb.append("var Datetime = Java.type('org.noear.think.utils.Datetime');");
            sb.append("var Timecount = Java.type('org.noear.think.utils.Timecount');");
            sb.append("var Timespan = Java.type('org.noear.think.utils.Timespan');");
